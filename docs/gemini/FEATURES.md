...
TrainingFlow is designed as an athlete training management platform with the following core modules:
...
- **Calendar Notes**: Add simple text notes to any day on the calendar. Notes are draggable, editable, and visually distinct from workouts. Notes can be duplicated with a target date/coordinate picker.
...
- **Workout Library**: Save and reuse workout templates. Users can create new templates directly from the slide-out Library Drawer without navigating away.
- **Weekly Stats & Metrics**: Detailed weekly summaries and sport-specific totals are permanently displayed on the calendar.
...
- **Training Plan Generator**:
    ...
    - **Advanced Plan Builder**:
        ...
        - **Advanced Toolset**: 
            - **Enhanced Bulk Delete**: Rapidly seed and refine plans with precise deletion criteria including date range, sport type, and days of week filters. Mobile-first UI with large tap targets.
            - **AI-Program Import**: Import structured training programs. Auto-scales `totalWeeks` to fit imported content (capped at 52).
