...
-- This baseline incorporates the pf_ to tf_ prefix rename and all subsequent schema changes.
...
CREATE TABLE public.tf_profiles (
    ...
    avatar_url text,
    calendar_stats_mode boolean NOT NULL DEFAULT true,
...
-- 3.4 tf_event_priorities Policies
...
-- 3.6 tf_event_segments Policies
...
-- 3.8 tf_library_workouts Policies
...
-- 3.9 tf_user_sport_settings Policies
